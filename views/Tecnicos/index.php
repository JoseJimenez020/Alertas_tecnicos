...
<head>
    ...
    <style>
        ...
        .bloqueo-card.motivo-no_se_presento {
        ...
        tr.inactivo>td:not(.bloqueos-col) {
            color: #888;
        }
        ...
        .bloqueo-card .bc-fechas {
            color: #555;
        }

        .bloqueo-card .bc-horas {
            color: #1a4d6d;
            font-size: 10px;
            margin-top: 2px;
        }

        .bloqueo-card .bc-desc {
            color: #666;
            font-style: italic;
            margin-top: 2px;
        }

        .bloqueo-card .bc-actions {
            display: flex;
            gap: 4px;
            margin-top: 4px;
        }

        .bloqueo-card.motivo-mecanico {
            border-left: 3px solid #c0392b;
        }

        .bloqueo-card.motivo-vacaciones {
            border-left: 3px solid #2e75b6;
        }

        .bloqueo-card.motivo-apoyo {
        ...
        .hora-check input[type="checkbox"] {
            display: none;
        }
        ...
        .campo-mecanico.visible,
        .campo-apoyo.visible,
        .campo-vacaciones.visible {
            display: block;
        }
                        ...
                        <td class="bloqueos-col" style="min-width:220px;">
                            <?php foreach ($bloqueos as $b):
                                ...
                                <div class="bloqueo-card motivo-<?= $motivoB ?>">
                                    ...
                                    <?php if ($horasStr): ?>
                                        <div class="bc-horas">🕐 <?= htmlspecialchars($horasStr) ?></div><?php endif; ?>
                                    <?php if ($b['descripcion']): ?>
                                        <div class="bc-desc"><?= htmlspecialchars($b['descripcion']) ?></div><?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        </td>
                        <td>
    ...
    <div class="modal-overlay" id="modalBloqueo">
        <div class="modal-box">
            ...
            <div class="modal-body">
                ...
                <div class="campo-mecanico campo-apoyo" id="seccionHoras">
                    <label style="margin-top:12px;">Horas a bloquear</label>
                    <div class="info-box" style="margin-top:6px;">
                        Selecciona las horas específicas que estarán bloqueadas. Usa "Todas" para bloquear el día
                        completo.
                    </div>
