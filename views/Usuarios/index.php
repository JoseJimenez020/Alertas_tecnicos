...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] .roles-ref {
            color: var(--text-secondary);
        }

        [data-theme="dark"] #colorPreviewBox {
            border-color: #555;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="roles-ref">
            ...
            <span>8 = Gestor</span>
            <span>9 = Recuperación de Clientes</span>
        </div>
        ...
        <div class="modal-box">
            ...
            <div class="modal-body">
                ...
                <select id="uRol">
                    ...
                    <option value="8">8 — Gestor</option>
                    <option value="9">9 — Recuperación de Clientes</option>
                </select>
    ...
    <script>
        ...
        const COLOR_HEX = {
            ...
            'bg-cajera': '#79308C', 'bg-cobranza': '#F4320B', 'bg-gestor': '#73F527',
        };
