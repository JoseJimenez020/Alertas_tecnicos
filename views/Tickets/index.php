...
<head>
    ...
    <style>
        ...
        .llamada-cell.calidad .llamada-label {
            color: #1a7a4a;
        }
        ...
        [data-theme="dark"] .filtros select,
        [data-theme="dark"] .filtros input[type="date"] {
        ...
        [data-theme="dark"] tr.estado-terminado td {
            background: #173a22 !important;
        }

        [data-theme="dark"] tr.estado-rojo td {
            background: #3a1a1a !important;
        }

        [data-theme="dark"] .llamada-sep {
            border-top-color: #3a4149;
        }

        [data-theme="dark"] .llamada-val {
            color: var(--text-primary);
        }
        ...
        <form method="GET" action="" id="formFiltros">
            ...
            <div class="filtros">
                <div class="f-group">
                    ...
                    <select name="tecnico_id">
                        ...
                        <?php foreach ($tecnicos as $tec): ?>
                            <option value="<?= $tec['TecnicoId'] ?>" <?= (($_GET['tecnico_id'] ?? '') == $tec['TecnicoId']) ? 'selected' : '' ?>>
                ...
                <div class="f-group">
                    ...
                    <select name="usuario_id">
                        ...
                        <?php foreach ($usuarios as $u): ?>
                            <option value="<?= $u['usu_id'] ?>" <?= (($_GET['usuario_id'] ?? '') == $u['usu_id']) ? 'selected' : '' ?>>
                ...
                <div class="f-group">
                    ...
                    <select name="estado">
                        <option value="">— Todos —</option>
                        <option value="pendiente" <?= (($_GET['estado'] ?? '') === 'pendiente') ? 'selected' : '' ?>>En
                            proceso</option>
                        <option value="terminado" <?= (($_GET['estado'] ?? '') === 'terminado') ? 'selected' : '' ?>>
                            Terminado</option>
                    </select>
                </div>
                <div class="f-group">
                    ...
                    <select name="tipo_ticket">
                        <option value="">— Todos —</option>
                        <option value="1" <?= (($_GET['tipo_ticket'] ?? '') === '1') ? 'selected' : '' ?>>Ticket normal
                        </option>
                        <option value="2" <?= (($_GET['tipo_ticket'] ?? '') === '2') ? 'selected' : '' ?>>Retiro de equipo
                        </option>
                    </select>
                </div>
